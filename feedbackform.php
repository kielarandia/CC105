...
<body class="agileits_w3layouts">
	<header>
	<a href="index.php" class="logo"><img src="img/logo_1.png" style="border-radius: 50%; width: 55px; height: 55px; margin-right: 60px; float: right;" alt=""></a>
	
	
	</header>
    <div class="w3layouts_main wrap" style="border-radius: 20px;">
	  ...
	  <h3>Please help us to serve you better by taking a couple of minutes. </h3>
	    <form action="feedback.php" method="post" class="agile_form">
		  <h2>How satisfied were you with our Service?</h2>
			...
			<input type="email" placeholder="Your Email (required)" name="email" required="" />
